  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScreenHeader title="Room Details" onBack={() => router.back()} />
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.detailsCard}>
          ...
          <RoomDetailRow icon="home-outline" label="Room Number" value={room.roomNumber} />
          <RoomDetailRow icon="layers-outline" label="Room Type" value={room.roomType} />
          <RoomDetailRow
            icon="cash-outline"
          ...
          <RoomDetailRow
            ...
            label="Created"
            value={room.createdAt ? new Date(room.createdAt).toLocaleDateString() : '—'}
            noBorder
          />
        </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoCardHeader}>
            ...
            {room.images && room.images.length > 0 && (
              <Text style={styles.imageCount}>{room.images.length} photo{room.images.length !== 1 ? 's' : ''}</Text>
            )}
          </View>
        ...
        <View style={styles.actionButtons}>
          ...
          >
            <Ionicons name="trash-outline" size={18} color={COLORS.maintenance} />
