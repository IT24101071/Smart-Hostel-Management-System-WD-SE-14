...
export default function RoomForm({
  ...
  async function pickImage(source) {
    ...
    if (!result.canceled && result.assets[0]) {
      setImageUris((prev) => [...prev, result.assets[0]]);
    }
  }
          ...
          <View style={styles.segmentedControl}>
            {ROOM_TYPES.map((type) => (
              <Pressable
                ...
                style={[
                  styles.segmentItem,
                  roomType === type && styles.segmentItemActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.segmentText,
                    roomType === type && styles.segmentTextActive,
                  ]}
                >
                  {type}
                </Text>
        ...
        <View style={styles.fieldGroup}>
          ...
          <View style={styles.stepperRow}>
            <Pressable
              style={[
                styles.stepperBtn,
                capacity <= 1 && styles.stepperBtnDisabled,
              ]}
      ...
      <SectionCard title="Room Images" icon="images-outline">
        ...
        {imageUris.length > 0 && (
          <Text style={styles.imageCountHint}>
            {imageUris.length} / {MAX_IMAGES} image
            {imageUris.length !== 1 ? "s" : ""} selected
          </Text>
        )}
      </SectionCard>
